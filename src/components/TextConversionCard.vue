...
const algorithm = ref<'Basic' | 'Dither' | 'Atkinson' | 'Bayer' | 'SierraLite'>(
    props.initialOptions?.algorithm ?? 'Atkinson',
);
...
const textConversionOptions = computed(
...
<template>
    <Card>
        ...
        <CardContent>
            <div class="mb-4">
                <Label class="block mb-2 font-medium" for="preprocess-filter"
                    >Preprocessing Filter</Label
                >
            ...
            <div class="mb-4">
                ...
                <p class="text-xs text-gray-500 mt-2">
                    <span v-if="algorithm === 'Basic'"
                        >Simple threshold - fast but jagged edges</span
                    >
                    <span v-else-if="algorithm === 'Dither'"
                        >Floyd-Steinberg - high quality, darker output</span
                    >
                    <span v-else-if="algorithm === 'Atkinson'"
                        >Recommended for text - lighter, cleaner edges</span
                    >
                    <span v-else-if="algorithm === 'Bayer'"
                        >Ordered pattern - good for gradients</span
                    >
